...
parser.add_argument('-Training_path', '--Training_path', default='../GridWorld2/train_set/') # The path to the training set
parser.add_argument('-Testing_path', '--Testing_path', default='../GridWorld2/test_set/') # The path to the testing set
parser.add_argument('-base_path', '--base_path', default='../GridWorld2/') # The base path for the training set
...
if not os.path.exists(Testing_path) or not os.path.exists(Training_path):
    create_env6(Testing_path, repeat_num=10)
    create_env6(Training_path, repeat_num=10)
