...
def input_prompt_1_func_total(starting_prompt_task_explain, state_update_prompt, goal_prompt, response_total_list,
                              pg_state_list, env_act_feedback_list):
    # import pdb; pdb.set_trace()
    if len(pg_state_list) - len(response_total_list) != 1:
        print('Length of pg_state_list:', len(pg_state_list))
  ...
  My goal is to have that {goal_prompt}
  ...
  Now, plan the next step, return the next one action in required format only:
  '''
