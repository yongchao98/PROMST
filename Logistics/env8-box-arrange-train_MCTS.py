...
parser.add_argument('-Training_path', '--Training_path', default='../Logistics/train_set/') # The path to the training set
parser.add_argument('-Testing_path', '--Testing_path', default='../Logistics/test_set/') # The path to the testing set
parser.add_argument('-base_path', '--base_path', default='../Logistics/') # The base path for the training set
