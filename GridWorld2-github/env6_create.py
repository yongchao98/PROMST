...
#Saving_path_test = '/home/ycchen/autoprompt/GridWorld2/test_set' # Put the current code directory path here
#create_env6(Saving_path_test, repeat_num = 10)

#Saving_path_train = '/home/ycchen/autoprompt/GridWorld2/train_set' # Put the current code directory path here
#create_env6(Saving_path_train, repeat_num = 10)
